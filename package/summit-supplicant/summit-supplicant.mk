...
ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_60),y)
SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE_60)-$(SUMMIT_SUPPLICANT_VERSION)
else ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_LWB_IF),y)
SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE_LWB)-$(SUMMIT_SUPPLICANT_VERSION)
else ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_NX),y)
SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE_NX)-$(SUMMIT_SUPPLICANT_VERSION)
else ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_TI),y)
SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE_TI)-$(SUMMIT_SUPPLICANT_VERSION)
else ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_BDSDMAC),y)
SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE_BDSDMAC)-$(SUMMIT_SUPPLICANT_VERSION)
else ifeq ($(BR2_PACKAGE_SUMMIT_FIRMWARE_MSD),y)
