...
SUMMIT_SUPPLICANT_VERSION = $(SUMMIT_RADIO_STACK_VERSION_VALUE)
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_SUPPLICANT_SITE = $(SUMMIT_RADIO_URI_BASE)-$(SUMMIT_SUPPLICANT_VERSION)
endif
...
SUMMIT_SUPPLICANT_CONFIGURATION =
...
SUMMIT_SUPPLICANT_CONFIGURATION += CONFIG_FIPS=y CONFIG_FIPS_SUMMIT=y
endif
...
define SUMMIT_SUPPLICANT_BUILD_CMDS
	...
	$(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_OPTS) \
		$(MAKE) -C $(@D)/wpa_supplicant BINDIR=/usr/sbin $(SUMMIT_SUPPLICANT_CONFIGURATION)
	$(TARGET_OBJCOPY) $(@D)/wpa_supplicant/wpa_supplicant $(@D)/wpa_supplicant/sdcsupp
endef

ifeq ($(BR2_PACKAGE_SUMMIT_SUPPLICANT_CLI),y)
define SUMMIT_SUPPLICANT_INSTALL_CLI
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/sbin $(@D)/wpa_supplicant/wpa_cli
endef
endif

ifeq ($(BR2_PACKAGE_SUMMIT_SUPPLICANT_PASSPHRASE),y)
define SUMMIT_SUPPLICANT_INSTALL_PASSPHRASE
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/sbin \
		$(@D)/wpa_supplicant/wpa_passphrase
endef
endif

ifeq ($(BR2_PACKAGE_SUMMIT_SUPPLICANT_WPA_CLIENT_SO),y)
...
ifeq ($(BR2_PACKAGE_SUMMIT_SUPPLICANT_DBUS),y)
...
define SUMMIT_SUPPLICANT_INSTALL_DBUS
	...
	$(INSTALL) -m 0644 -D $(@D)/wpa_supplicant/dbus/fi.w1.wpa_supplicant1.service \
		$(TARGET_DIR)/usr/share/dbus-1/system-services/fi.w1.wpa_supplicant1.service$(if $(BR2_PACKAGE_WPA_SUPPLICANT),.summit,)
	$(SUMMIT_SUPPLICANT_INSTALL_DBUS_OVERLAY_CONF)
endef
else
SUMMIT_SUPPLICANT_CONFIGURATION += NO_CONFIG_CTRL_IFACE_DBUS_NEW=y
endif
...
define SUMMIT_SUPPLICANT_INSTALL_TARGET_CMDS
	...
	$(SUMMIT_SUPPLICANT_INSTALL_CLI)
	$(SUMMIT_SUPPLICANT_INSTALL_PASSPHRASE)
