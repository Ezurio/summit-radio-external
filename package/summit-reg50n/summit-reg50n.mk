...
SUMMIT_REG50N_VERSION = $(SUMMIT_RADIO_STACK_VERSION_VALUE)
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_REG50N_SITE = $(SUMMIT_RADIO_URI_BASE)-$(SUMMIT_REG50N_VERSION)
endif
...
define SUMMIT_REG50N_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/bin $(@D)/lru_50 $(@D)/smu_cli $(@D)/tcmd.sh
