...
SUMMIT_MFG60N_VERSION = $(SUMMIT_RADIO_STACK_VERSION_VALUE)
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_MFG60N_SITE = $(SUMMIT_RADIO_URI_BASE)-$(SUMMIT_MFG60N_VERSION)
endif
...
define SUMMIT_MFG60N_LMU_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/bin  $(@D)/lmu$(SUMMIT_MFG60N_EXT)
endef
endif
...
define SUMMIT_MFG60N_BTLRU_INSTALL_TARGET_CMD
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/bin  $(@D)/btlru$(SUMMIT_MFG60N_EXT)
endef
endif

define SUMMIT_MFG60N_REGULATORY_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/bin  $(@D)/lru$(SUMMIT_MFG60N_EXT)
