...
SUMMIT_LINUX_BACKPORTS_VERSION = $(SUMMIT_RADIO_STACK_VERSION_VALUE)

ifeq ($(BR2_PACKAGE_SUMMIT_LINUX_BACKPORTS_LOCAL),y)
  SUMMIT_LINUX_BACKPORTS_VERSION = $(if $(VERSION),$(VERSION),0.$(BR2_SUMMIT_BRANCH).0.0)
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_LINUX_BACKPORTS_SITE = $(SUMMIT_RADIO_URI_BASE)-$(SUMMIT_LINUX_BACKPORTS_VERSION)
endif
...
.SECONDEXPANSION:
$(SUMMIT_LINUX_BACKPORTS_DIR)/.stamp_check_kernel_version: $(SUMMIT_LINUX_BACKPORTS_TARGET_PATCH) $$(LINUX_DIR)/$$(LINUX_KCONFIG_STAMP_DOTCONFIG) | linux
