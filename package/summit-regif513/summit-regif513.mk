...
SUMMIT_REGIF513_VERSION = $(SUMMIT_RADIO_STACK_VERSION_VALUE)
...
ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  ...
  SUMMIT_REGIF513_SITE = $(SUMMIT_RADIO_URI_BASE)-$(SUMMIT_REGIF513_VERSION)
endif
...
define SUMMIT_REGIF513_BTLRU_INSTALL_TARGET_CMD
	$(INSTALL) -D -m 755 -t $(TARGET_DIR)/usr/bin $(@D)/btlru$(SUMMIT_REGIF513_EXT) 
endef
endif

define SUMMIT_REGIF513_INSTALL_TARGET_CMDS
	$(SUMMIT_REGIF513_BTLRU_INSTALL_TARGET_CMD)
	$(INSTALL) -D -m 775 -t $(TARGET_DIR)/usr/bin $(@D)/lru$(SUMMIT_REGIF513_EXT)
